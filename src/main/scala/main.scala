...
@main def runInterpreter(): Unit =
  ...
  println(s"[Call-By-Name]  Результат: ${resCBN.term.show} | Кроків: ${resCBN.stepsTaken} | Нормальна форма: ${resCBN.isNormalForm}")
  ...
  println(s"[Call-By-Value] Результат: ${resCBV.term.show} | Кроків: ${resCBV.stepsTaken} | Нормальна форма: ${resCBV.isNormalForm}")
  println("==============================================")